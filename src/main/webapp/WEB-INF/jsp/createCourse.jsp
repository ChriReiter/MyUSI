    ...
    <form:form modelAttribute="course" method="post" action="newCourse">
        ...
        <fieldset>
            ...
            <div class="mb-3">
                ...
                <form:input path="courseName" id="inputCourseName"/>
            ...
            <div class="mb-3">
                ...
                <form:input path="numSpaces" id="inputNumSpaces"/>
