        ...
        <fieldset>
            ...
            <div class="container-xl">
                <div class="mb-3">
                    ...
                    <form:input path="courseName" id="inputCourseName" cssStyle="width: 100%"/>
                ...
                <div class="mb-3">
                    ...
                    <form:input path="description" id="inputDescription" cssStyle="width: 100%"/>
                ...
                <div class="mb-3">
                    ...
                    <form:input path="numSpaces" id="inputNumSpaces" type="number" step="1" cssStyle="width: 100%"/>
                ...
                <div class="mb-3">
                    ...
                    <form:input path="price" id="inputPrice" type="number" step="0.01" cssStyle="width: 100%"/>
            ...
            <div class="container-xl">
                ...
                <div class="mb-3">
                    ...
                    <form:input path="timeStart" id="inputStartTime" type="time" cssStyle="width: 100%"/>
                    <form:errors path="timeStart" cssClass="invalid-feedback" />
                </div>
                <div class="mb-3">
                    <label for="inputEndTime" class="form-label">End Time</label>
                    <form:input path="timeEnd" id="inputEndTime" type="time" cssStyle="width: 100%"/>
